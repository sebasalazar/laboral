...
INSERT INTO usuarios (username, password, salt, roles) VALUES ('22222222','22abd99950e28b5d3953ecc800e4bce7','50c8b5d98ba193.37411008', '4');
...
INSERT INTO usuarios (username, password, salt, roles) VALUES ('44444444','22abd99950e28b5d3953ecc800e4bce7','50c8b5d98ba193.37411008', '2');
...
INSERT INTO encargados_practicas (rut_epracti, nombre_encargado, apellido_encargado, empresa_fk, area_practica_fk) VALUES ('44444444', 'Rodrigo', 'Rosas', '1', '26');
INSERT INTO empresas (rut, nombre, direccion, comuna_fk, codigo_postal, telefono, email, actividad_fk, descripcion_negocio, web) VALUES ('44444441', 'Chantilli Software', 'Algún Lugar', '345', '123456', '25555555', 'contacto@chantilli.cl', '30', 'Descripción', 'http://chantilli.cl');
INSERT INTO encargados_empresas (empresa_fk, rut_encargado, nombre, apellidos, genero, direccion, comuna_fk, email, telefono) VALUES ('1', '44444441', 'Ricardo', 'Sabelotodo', 'M', 'sfsdafas dsfdasfsdf', '345', 'pzapata@chantilli.cl', '25555555');
INSERT INTO empresas (rut, nombre, direccion, comuna_fk, codigo_postal, telefono, email, actividad_fk, descripcion_negocio, web) VALUES ('44444442', 'Pudroski Porduction', 'Sin dirección', '345', '123456', '21235546', 'contacto@pudroski.cl', '13', 'Descripción', 'http://pudroski.cl');
INSERT INTO encargados_empresas (empresa_fk, rut_encargado, nombre, apellidos, genero, direccion, comuna_fk, email, telefono) VALUES ('1', '44444442', 'Chantoski', 'Putridoski', 'M', 'werewqr kñklñ', '345', 'pzapata@pudroski.cl', '27775546');
...
--Oferta laboral
INSERT INTO ofertas_laborales(empresa_fk, rubro_fk, nivel_estudio_fk, renta, vacantes, descripcion, ubicacion, cargo, beneficios,
jornada_fk, contrato_fk) VALUES (1, 26, 1, 500000, 2, 'Trabajo estresante', 'Santiago centro', 'N/A', 'Seguro mental', 1, 1);
