...
class Carreras extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('cod_carrera, nombre_carrera', 'required'),
			array('cod_carrera', 'numerical', 'integerOnly'=>true),
			array('nombre_carrera', 'length', 'max'=>50),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('pk, cod_carrera, nombre_carrera', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'estudiantes' => array(self::HAS_MANY, 'Estudiantes', 'carrera_fk'),
		);
	}
