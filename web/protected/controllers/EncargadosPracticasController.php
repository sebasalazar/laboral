...
class EncargadosPracticasController extends Controller
{
	/**
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('update','index','create','delete','view'),
				'users'=>array('@'),
			),
	...
	public function actionCreate()
	{
            ...
            {
                $model=new EncargadosPracticas;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['EncargadosPracticas']))
		{
			$model->attributes=$_POST['EncargadosPracticas'];
			if($model->save())
	...
	{
		$model=EncargadosPracticas::model()->findByPk((int) $id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='encargados-practicas-form')
		{
