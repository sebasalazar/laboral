                            ...
                            array(
                                ...
                                'items'=>array(
                                    ...
                                    array('label'=>'CV','items'=>array(
                                        array('label'=>'Actualizar Mis Datos','url'=>array('/estudiantes/updateperfil','rut'=>Yii::app()->user->name),'visible'=>Yii::app()->user->isEstudiante()),
                                        array('label'=>'Subir Mi Curriculum','url'=>array('estudiantes/updateperfil4', 'rut'=>Yii::app()->user->name),'visible'=>Yii::app()->user->isEstudiante(),),)),
                                     array('label'=>'Practicas', 'items'=>array(
                            ...
                            array(
                                ...
                                'items'=>array(
                                    ...
                                    array('label'=>$rut, 'url'=>'#', 'items'=>array(
                                        ...
                                        array('label'=>'Emails Docente', 'url'=>array('docentes/contacto'), 'visible'=>Yii::app()->user->isDocente()),
