...
<tr>
    ...
    <tr class="odd"><td> <b>Grado de cumplimiento y dedicación: </b> </td><td class="fila2"> '.$model->grado_cumplimiento.'</td></tr>
    <tr class="odd"><td> <b>Puntualidad y respeto de las normas etablecidas: </b> </td><td class="fila2"> '.$model->puntualidad_respeto.'</td></tr>
    <tr class="odd"><td> <b>Capacidad de integración y/o adaptación: </b> </td><td class="fila2"> '.$model->integracion_adaptacion.'</td></tr>
    <tr class="odd"><td> <b>Responsabilidad, autocrítica y superación: </b> </td><td class="fila2"> '.$model->responsabilidad_superacion.'</td></tr>
    <tr class="odd"><td> <b>Personalidad, lenguaje, presencia y seguridad: </b> </td><td class="fila2"> '.$model->capacidades_personales.'</td></tr>
    <tr class="odd"><td> <b>Iniciativa, creatividad y capacidad de improvisación: </b> </td><td class="fila2"> '.$model->iniciativa_creativi_improvi.'</td></tr>
</table>
...
$mpdf->WriteHTML($html);
$mpdf->Output('EvaluacionPracticaUTEM.pdf','I');
exit;
